                ...
                <div className="mt-10 text-center">
                    {selectedPlan !== null && (
                        <div className="bg-gray-50 p-6 rounded-md shadow-md mt-4">
                            ...
                            <p className="m-6 text-gray-700 text-wrap text-center ">
                                {serviceData[selectedPlan].description}
                            </p>
