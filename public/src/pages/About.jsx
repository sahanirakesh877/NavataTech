                    ...
                    <div className="grid lg:grid-cols-2 sm:grid-cols-1 gap-6 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-900 md:text-base lg:text-md lg:ml-6 mb-4">
                                ...
                                , where innovation meets technology! We
                                specialize in crafting exceptional digital
                                solutions that redefine your online presence.
                                From cutting-edge web design and custom app
                                development to captivating graphics and
                                strategic digital marketing, we are your
                                partners in success.
                            </p>
                            <p className="text-gray-900 text-sm md:text-base lg:text-md lg:ml-6 mb-4">
                                Our team of experts harnesses the latest tools
                                and creativity to build tailor-made solutions
                                aligned with your brand's vision. We're not just
                                about creating websites or apps; we're about
                                crafting digital experiences that engage,
                                inspire, and drive results. Let's collaborate
                                and propel your business to new heights in the
                                digital landscape.
                            </p>
