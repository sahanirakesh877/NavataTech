        ...
        <div className="grid sm:grid-cols-2 items-center gap-16 py-24 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] ">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-3">
              We are innovatives to web design , software development , App
              Development , Digital Marketing , SEO optimizations , Page
              Boosting
            </p>
            <div className="mt-8">
          ...
          >
            <input
              type="text"
              placeholder="Name"
              className="w-full rounded-md py-2.5 px-4 border text-sm outline-primary"
              value={name}
            ...
            <textarea
              placeholder="Message"
              rows={6}
              className="w-full rounded-md px-4 border text-sm pt-2.5 outline-primary"
              value={message}
              onChange={(e) => setMessage(e.target.value)}
            />
            <button
              type="submit"
              className="text-white bg-primary hover:bg-sec font-semibold rounded-md text-sm px-4 py-2.5 w-full"
            >
              Send
            </button>
          </form>
